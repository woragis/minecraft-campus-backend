...
type Player struct {
	...
	UniversitySlug  *string    `gorm:"column:university_slug" json:"universitySlug,omitempty"`
	FacultySlug     *string    `gorm:"column:faculty_slug" json:"facultySlug,omitempty"`
	CourseSlug      *string    `gorm:"column:course_slug" json:"courseSlug,omitempty"`
